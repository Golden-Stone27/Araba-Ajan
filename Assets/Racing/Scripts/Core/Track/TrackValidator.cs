...
{
    /// <summary>M1 track acceptance criteria (see M1 spec, "Validator").</summary>
    public static class TrackValidator
    {
        ...
        public static Report Validate(TrackGeometry g)
        {
            ...
            {
                if (c.MinRadius >= 12f && c.MinRadius <= 20f && c.TurnDeg >= 120f) r.HasHairpin = true;
            ...
            for (int i = 0; i < sorted.Count; i++)
            {
                ...
                if (a.Sign != b.Sign && gap < 30f && a.MinRadius < 60f && b.MinRadius < 60f) r.HasChicane = true;
            }
